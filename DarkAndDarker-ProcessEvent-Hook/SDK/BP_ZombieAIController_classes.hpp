...
class ABP_ZombieAIController_C final : public ABP_DCMonsterAIController_C
{
public:
...
static_assert(sizeof(ABP_ZombieAIController_C) == 0x000458, "Wrong size on ABP_ZombieAIController_C");
