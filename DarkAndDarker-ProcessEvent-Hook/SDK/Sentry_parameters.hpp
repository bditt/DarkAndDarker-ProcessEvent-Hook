...
public:
	...
	uint8                                         Pad_1E23[0x7];                                     // 0x0011(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1E26[0x7];                                     // 0x0081(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	class FString                                 Message;                                           // 0x0000(0x0010)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESentryLevel                                  Level;                                             // 0x0010(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1E27[0x7];                                     // 0x0011(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class USentryEvent*                           ReturnValue;                                       // 0x0018(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(SentryLibrary_CreateSentryUserFeedback, Param_Name) == 0x000008, "Member 'SentryLibrary_CreateSentryUserFeedback::Param_Name' has a wrong offset!");
...
public:
	...
	TMap<class FString, class FString>            Data;                                              // 0x0030(0x0050)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	ESentryLevel                                  Level;                                             // 0x0080(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1E33[0x7];                                     // 0x0081(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	class FString                                 Message;                                           // 0x0000(0x0010)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESentryLevel                                  Level;                                             // 0x0010(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1E34[0x7];                                     // 0x0011(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class USentryId*                              ReturnValue;                                       // 0x0018(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                         Pad_1E35[0x7];                                     // 0x0021(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(SentrySubsystem_CaptureUserFeedbackWithParams, Param_Name) == 0x000028, "Member 'SentrySubsystem_CaptureUserFeedbackWithParams::Param_Name' has a wrong offset!");
...
static_assert(offsetof(SentryUserFeedback_SetName, Param_Name) == 0x000000, "Member 'SentryUserFeedback_SetName::Param_Name' has a wrong offset!");
