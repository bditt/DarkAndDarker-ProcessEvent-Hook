...
#include "BP_FireballProjectile_classes.hpp"
#include "BP_FireballProjectile_parameters.hpp"
...
void ABP_FireballProjectile_C::ExecuteUbergraph_BP_FireballProjectile(int32 EntryPoint)
{
	...
	Params::BP_FireballProjectile_C_ExecuteUbergraph_BP_FireballProjectile Parms{};
...
void ABP_FireballProjectile_C::GameplayTagUpdated(const struct FGameplayTag& InGameplayTag, int32 InCount)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_FireballProjectile_C", "GameplayTagUpdated");

	Params::BP_FireballProjectile_C_GameplayTagUpdated Parms{};
...
void ABP_FireballProjectile_C::ReceiveEndPlay(EEndPlayReason EndPlayReason)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_FireballProjectile_C", "ReceiveEndPlay");

	Params::BP_FireballProjectile_C_ReceiveEndPlay Parms{};
