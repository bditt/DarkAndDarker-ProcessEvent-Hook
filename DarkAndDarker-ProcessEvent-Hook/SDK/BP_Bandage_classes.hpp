...
class ABP_Bandage_C final : public ABP_DCItemActor_C
{
public:
...
static_assert(alignof(ABP_Bandage_C) == 0x000008, "Wrong alignment on ABP_Bandage_C");
static_assert(sizeof(ABP_Bandage_C) == 0x000568, "Wrong size on ABP_Bandage_C");
