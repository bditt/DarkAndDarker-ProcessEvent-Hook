...
namespace Offsets
{
	constexpr int32 GObjects          = 0x092CDDE0;
	constexpr int32 AppendString      = 0x00D58100;
	constexpr int32 GNames            = 0x09227440;
	constexpr int32 GWorld            = 0x0943E658;
	constexpr int32 ProcessEvent      = 0x00F34000;
