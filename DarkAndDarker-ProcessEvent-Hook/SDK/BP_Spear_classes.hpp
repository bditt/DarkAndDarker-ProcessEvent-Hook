...
class ABP_Spear_C final : public ABP_DCItemActor_C
{
public:
...
static_assert(alignof(ABP_Spear_C) == 0x000008, "Wrong alignment on ABP_Spear_C");
static_assert(sizeof(ABP_Spear_C) == 0x000570, "Wrong size on ABP_Spear_C");
static_assert(offsetof(ABP_Spear_C, UberGraphFrame) == 0x000568, "Member 'ABP_Spear_C::UberGraphFrame' has a wrong offset!");
