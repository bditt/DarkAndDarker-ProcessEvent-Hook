...
class USentryUserFeedback* USentryLibrary::CreateSentryUserFeedback(class USentryId* EventId, const class FString& Param_Name, const class FString& Email, const class FString& Comments)
{
	static class UFunction* Func = nullptr;
...
void USentrySubsystem::CaptureUserFeedbackWithParams(class USentryId* EventId, const class FString& Email, const class FString& Comments, const class FString& Param_Name)
{
	static class UFunction* Func = nullptr;
...
void USentryUserFeedback::SetName(const class FString& Param_Name)
{
	static class UFunction* Func = nullptr;
